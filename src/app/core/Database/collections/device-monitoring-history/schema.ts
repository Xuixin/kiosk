...
export interface DeviceMonitoringHistoryDocument {
  id: string;
  device_id: string;
  type: string;
  status: string;
...
export const DEVICE_MONITORING_HISTORY_SCHEMA_LITERAL: RxJsonSchema<DeviceMonitoringHistoryDocument> =
  {
    title: 'DeviceMonitoringHistory',
    description:
      'Device monitoring history schema - revision history of device-monitoring',
    version: 0,
    primaryKey: 'id',
    ...
    properties: {
      ...
      device_id: { type: 'string', maxLength: 200 },
...
export const deviceMonitoringHistorySchema = toTypedRxJsonSchema(
  DEVICE_MONITORING_HISTORY_SCHEMA_LITERAL,
);

export type RxDeviceMonitoringHistoryDocumentType =
  ExtractDocumentTypeFromTypedRxJsonSchema<
    typeof deviceMonitoringHistorySchema
  >;

export const DEVICE_MONITORING_HISTORY_SCHEMA: RxJsonSchema<RxDeviceMonitoringHistoryDocumentType> =
  DEVICE_MONITORING_HISTORY_SCHEMA_LITERAL;

// Export adapter-compatible schema
export const DEVICE_MONITORING_HISTORY_SCHEMA_ADAPTER: SchemaDefinition =
  convertRxDBSchemaToAdapter(
    'device_monitoring_history',
    DEVICE_MONITORING_HISTORY_SCHEMA as any,
  );
